...
const TESTIMONIALS: Testimonial[] = [
  ...
  { name: "Priya S.", role: "Investor since 2022", quote: "Zypherex was the only platform I compared that showed target rates and durations without burying the risk language." },
